...
_COMMON_ARGS = [
    ...
    (
        "# Ueberhaupt braeuchte es mal einen Teststring mit Markdown.",
        False,
        "# Überhaupt bräuchte es mal einen Teststring mit Markdown.",
        nullcontext(),
    ),
    (
        "*Ueberhaupt braeuchte es mal einen Teststring mit Markdown.*",
    ...
    (
        "_Ueberhaupt braeuchte es mal einen Teststring mit Markdown._",
        False,
        "_Überhaupt bräuchte es mal einen Teststring mit Markdown._",
        nullcontext(),
    ),
    (
        "_*Ueberhaupt braeuchte es mal einen Teststring mit Markdown.*_",
        False,
        "_*Überhaupt bräuchte es mal einen Teststring mit Markdown.*_",
        nullcontext(),
    ),
    (
        "*_Ueberhaupt braeuchte es mal einen Teststring mit Markdown._*",
    ...
    (
        "__Ueberhaupt braeuchte es mal einen Teststring mit Markdown.__",
        False,
        "__Überhaupt bräuchte es mal einen Teststring mit Markdown.__",
        nullcontext(),
    ),
    (
        "*natuerlich*",
    ...
    (
        "[natuerlich](www.example.com)",
        False,
        "[natürlich](www.example.com)",
        nullcontext(),
    ),
    (
        "[*natuerlich*](www.example.com)",
    ...
    (
        "[_natuerlich_](www.example.com)",
        False,
        "[_natürlich_](www.example.com)",
        nullcontext(),
    ),
    (
